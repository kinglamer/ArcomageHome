...
namespace Arcomage.Tests.MoqStartParams
{
    class TestStartParams3 : IStartParams
    {
        ...
        public TestStartParams3(int countGenerate = 0)
        {
            MaxPlayerCard = 20;
            ...
            else
            {
                ...
                DefaultParams.Add(Attributes.Menagerie, 2);
